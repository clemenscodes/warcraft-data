//! [`AllRaces`]: the exhaustive set of the five races, made unforgeable by
//! giving each race its own distinct marker type.

use crate::domain::race::kind::Race;
...
// DDD role: the exhaustive race set is an immutable Value Object.
